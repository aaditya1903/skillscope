    ...
    <div className="app">
      ...
      <main>
        ...
        <div hidden={route.view !== 'search'}>
          <SearchView onOpenSkill={openSkill} />
        </div>
      </main>

      <footer className="footnote">
        <p>
          Indexed skills are untrusted third-party content, rendered as inert text and
          never executed. Each skill remains governed by its own repository licence.
        </p>
